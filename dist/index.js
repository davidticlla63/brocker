...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } //import {transporter} from './mailers'
...
var db = _database.sequelize;
function conectar() {
  return _conectar.apply(this, arguments);
}
function _conectar() {
  _conectar = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
