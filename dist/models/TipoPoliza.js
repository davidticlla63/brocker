...
var TipoPoliza = _database.sequelize.define('TipoPoliza', {
  id: {
...
TipoPoliza.hasMany(_Poliza["default"], {
  foreignKey: 'companiaseguroid',
  sourceKey: 'id'
});
_Poliza["default"].belongsTo(TipoPoliza, {
  foreignKey: 'companiaseguroid',
  sourceKey: 'id'
});
var _default = exports["default"] = TipoPoliza;