...
var contratantes = _interopRequireWildcard(require("../controllers/contratante.controller"));
...
router.get('/contratantePorEmpresa/:empresaid', contratantes.getContratantesPorEmpresa); // /api/empresas/:empresaID
