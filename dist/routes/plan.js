...
var plans = _interopRequireWildcard(require("../controllers/plan.controller"));
...
router.get('/planesPorCompania/:companiaseguroid', plans.getPlansPorCompania); // /api/empresas/:empresaID
