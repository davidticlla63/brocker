...
var requisitos = _interopRequireWildcard(require("../controllers/requisito.controller"));
...
router.get('/requisitosPorSiniestro/:siniestroid', requisitos.getRequisitoPorSiniestro); // /api/empresas/:empresaID
