...
var companiaSeguros = _interopRequireWildcard(require("../controllers/companiaSeguro.controller"));
...
router.get('/', companiaSeguros.getCompaniaSeguros); // /api/empresas/:empresaID
