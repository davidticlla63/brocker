...
var cobranzaMotivos = _interopRequireWildcard(require("../controllers/cobranzaMotivo.controller"));
...
router.get('/', cobranzaMotivos.getCobranzaMotivos); // /api/empresas/:empresaID
