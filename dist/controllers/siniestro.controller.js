...
function _getSiniestros() {
  _getSiniestros = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var siniestros;
...
function _createSiniestro() {
  _createSiniestro = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
...
function _updateSiniestro() {
  _updateSiniestro = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
...
function _getOneSiniestro() {
  _getOneSiniestro = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, usuario;
...
function _deleteSiniestro() {
  _deleteSiniestro = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
...
function _bajaSiniestro() {
  _bajaSiniestro = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
...
function _getSiniestroPorSucursal() {
  _getSiniestroPorSucursal = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
...
function _getSiniestroPorEmpresa() {
  _getSiniestroPorEmpresa = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
...
function _getTotalSiniestrosPorEmpresa() {
  _getTotalSiniestrosPorEmpresa = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
...
function _getTotalSiniestrosPorSucursal() {
  _getTotalSiniestrosPorSucursal = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
