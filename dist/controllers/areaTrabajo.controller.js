...
function _getAreaTrabajos() {
  _getAreaTrabajos = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var usuarios;
...
function _createAreaTrabajo() {
  _createAreaTrabajo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, nombre, descripcion, empresaid, usuarioregistro, usuariomodificacion, estado, newAreaTrabajo;
...
function _getOneAreaTrabajo() {
  _getOneAreaTrabajo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, usuario;
...
function _deleteAreaTrabajo() {
  _deleteAreaTrabajo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
...
function _updateAreaTrabajo() {
  _updateAreaTrabajo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var id, _req$body2, nombre, descripcion, empresaid, usuarioregistro, usuariomodificacion, estado, updateRowCount, areaTrabajos;
...
function _bajaAreaTrabajo() {
  _bajaAreaTrabajo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
...
function _areaTrabajoByEmpresa() {
  _areaTrabajoByEmpresa = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
