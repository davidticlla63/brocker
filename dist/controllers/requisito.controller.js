      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.prev = 1;
            _context8.next = 4;
            return _database.sequelize.query("select case when sr.requisitoid is null then false else true end estado,r.id,r.nombre from requisito r " + " left join siniestro_requisito sr on sr.requisitoid=r.id and sr.estado='ACT' AND sr.siniestroid='" + siniestroid + "' " + " WHERE r.estado='ACT' ", {
