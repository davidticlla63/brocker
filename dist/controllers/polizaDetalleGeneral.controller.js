...
function getPolizaDetalleGenerals(_x, _x2) {
  return _getPolizaDetalleGenerals.apply(this, arguments);
}
function _getPolizaDetalleGenerals() {
  _getPolizaDetalleGenerals = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var polizaDetalleGenerals;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _PolizaDetalleGeneral["default"].findAll({
            where: {
              estado: 'ACT'
            }
          });
        case 3:
          polizaDetalleGenerals = _context.sent;
          res.json({
...
function createPolizaDetalleGeneral(_x3, _x4) {
  return _createPolizaDetalleGeneral.apply(this, arguments);
}
function _createPolizaDetalleGeneral() {
  _createPolizaDetalleGeneral = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, titular, placa, tipovehiculo, marcavehiculo, colorvehiculo, aniovehiculo, primaindividual, primanetaindividualbs, primanetaindividualusd, usuarioregistro, usuariomodificacion, _req$body$fecharegist, fecharegistro, _req$body$fechamodifi, fechamodificacion, estado, polizaid, adicionales, t, newPolizaDetalleGeneral, i;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          newPolizaDetalleGeneral = _context2.sent;
          i = 0;
        case 9:
          ...
          _context2.next = 12;
          return PolizaDetalleGeneralAdicional.create({
...
function updatePolizaDetalleGeneral(_x5, _x6) {
  return _updatePolizaDetalleGeneral.apply(this, arguments);
}
function _updatePolizaDetalleGeneral() {
  _updatePolizaDetalleGeneral = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, _req$body2, titular, placa, tipovehiculo, marcavehiculo, colorvehiculo, aniovehiculo, primaindividual, primanetaindividualbs, primanetaindividualusd, usuarioregistro, usuariomodificacion, fecharegistro, _req$body2$fechamodif, fechamodificacion, estado, updateRowCount, polizaDetalleGenerals;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          _context3.next = 8;
          return _PolizaDetalleGeneral["default"].findOne({
            where: {
              id: id
            }
          });
        case 8:
          polizaDetalleGenerals = _context3.sent;
          res.json({
...
function bajaPolizaDetalleGeneral(_x7, _x8) {
  return _bajaPolizaDetalleGeneral.apply(this, arguments);
}
function _bajaPolizaDetalleGeneral() {
  _bajaPolizaDetalleGeneral = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, usuariomodificacion, updateRowCount, polizaDetalleGenerals;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 9:
          polizaDetalleGenerals = _context4.sent;
          res.json({
...
function getPolizaDetalleGeneralPorPoliza(_x9, _x10) {
  return _getPolizaDetalleGeneralPorPoliza.apply(this, arguments);
}
function _getPolizaDetalleGeneralPorPoliza() {
  _getPolizaDetalleGeneralPorPoliza = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
...
function polizaDetalleGeneralsPorPoliza(_x11, _x12) {
  return _polizaDetalleGeneralsPorPoliza.apply(this, arguments);
}
function _polizaDetalleGeneralsPorPoliza() {
  _polizaDetalleGeneralsPorPoliza = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var polizaid, polizaDetalleGenerals;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 5:
          polizaDetalleGenerals = _context6.sent;
          res.json({
            data: polizaDetalleGenerals
          });
          _context6.next = 13;
...
function deletePolizaDetalleGeneral(_x13, _x14) {
  return _deletePolizaDetalleGeneral.apply(this, arguments);
}
function _deletePolizaDetalleGeneral() {
  _deletePolizaDetalleGeneral = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          id = req.params.id;
          _context7.next = 4;
          return _PolizaDetalleGeneral["default"].destroy({
            where: {
              id: id
            }
          });
