...
select
    '26a0593e-c496-4e05-8bea-57eb30d4a41e',
    id,
    'DTICLLA',
    NOW(),
    'ACT'
...
CREATE TABLE IF NOT EXISTS poliza_detalle(
    ...
    porcentajeprima decimal  default 0,
    primaneta decimal  default 0,
...
CREATE TABLE IF NOT EXISTS poliza_detalle_automotor(
    ...
    valorasegurado decimal  default 0,
    usuarioregistro character varying not null,
    usuariomodificacion character varying,
    fecharegistro timestamp,
    fechamodificacion timestamp,
...
values
    ...
    (
        'Formulario de declaracion del siniestro por el asegurado',
        'requisito 2',
        'fd2169be-1d80-4416-a009-a07658f1678e',
        'dticlla',
        now(),
    ...
    (
        'Denuencia Transito y/o Diprove',
        'requisito 4',
        'fd2169be-1d80-4416-a009-a07658f1678e',
        'dticlla',
        now(),
    ...
    (
        'Determinación Técnica del tránsito',
        'requisito 5',
        'fd2169be-1d80-4416-a009-a07658f1678e',
        'dticlla',
        now(),
    ...
    (
        'Aloholemia afectada al momento del accidente',
        'requisito 6',
        'fd2169be-1d80-4416-a009-a07658f1678e',
        'dticlla',
        now(),
    ...
    (
        'Proformas reparación y/o reposición',
        'requisito 6',
        'fd2169be-1d80-4416-a009-a07658f1678e',
        'dticlla',
        now(),
    ...
    (
        'Pago de deducción de franquicia',
        'requisito 6',
        'fd2169be-1d80-4416-a009-a07658f1678e',
        'dticlla',
        now(),
...
CREATE TABLE IF NOT EXISTS envio_correo(
    --id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    id character varying PRIMARY KEY DEFAULT gen_random_uuid(),
    nro int NOT NULL GENERATED ALWAYS AS IDENTITY,
    descripcion character varying,
    usuarioregistro character varying not null,
    usuariomodificacion character varying,
    fecharegistro timestamp not null,
